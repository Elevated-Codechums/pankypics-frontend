		...
		<div className="min-h-screen flex flex-col gap-5">
			<div className="w-full flex flex-col items-center justify-center mt-10">
				<div className="bg-black text-white w-full py-20 px-20 flex flex-col items-center justify-center gap-5">
					<h3 className="text-5xl font-afacad font-bold">Albums</h3>
					<p className="text-lg font-raleway">
						Here are all the albums you&apos;ve created. Click on an
						album to view its photos.
					</p>
				</div>
				...
				<div className={cn("flex items-center justify-center w-full")}>
					...
					{isFetched && (
						<div
							className={cn(
								"grid grid-cols-3 items-center justify-center p-5"
							)}
						>
