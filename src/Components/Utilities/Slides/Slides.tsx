...
export function LandscapeSlides({ images, interval }: SlidesProps) {
	...
	return (
		<div
			className={cn("w-full flex flex-col-reverse gap-5 justify-between")}
		>
			...
			<div className="flex items-center w-full">
				<div
					className={cn(
						"relative",
						"min-[1288px]:w-[1200px] min-[1101px]:w-[1000px] min-[895px]:w-[800px] min-[550px]:w-[500px] w-[300px]",
						"min-[1288px]:h-[600px] min-[895px]:h-[500px] min-[550px]:h-[400px] h-[200px]"
					)}
				>
