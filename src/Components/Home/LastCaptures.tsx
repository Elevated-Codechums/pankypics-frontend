...
export default function LastCaptures() {
    return (
        <div className="min-h-screen flex justify-center items-center bg-backgroundwhite">
            <div className="h-[90%] w-[94%] bg-darkbrown rounded-3xl flex flex-col gap-8 p-6 md:p-12">
